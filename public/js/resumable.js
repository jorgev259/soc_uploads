...
/* global Blob, alert, File, XMLHttpRequest, FormData, FileReader, define */
...
(function () {
  ...
  var Resumable = function (opts) {
    ...
    var onDrop = function (e) {
      ...
      if (e.dataTransfer && e.dataTransfer.items) loadFiles(e.dataTransfer.items, e)
    ...
    var appendFilesFromFileList = function (fileList, event) {
      ...
      var files = []; var filesSkipped = []; var remaining = fileList.length
